...
from principal.models import (
    ...
    CursoFS, Municipio, Pais, TipoAtividadeComplementar
)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        importar_excel('Tabela de Áreas do Conhecimento.xlsx', AreaConhecimento, 'area_conhecimento', 'area_codigo')
        importar_excel('Tabela de Cursos de Formação Superior.xlsx', CursoFS, 'cfs_nome_grau', 'cfs_id')
        importar_excel('Tabela de Municípios.xlsx', Municipio, 'municipio_nome', 'municipio_codigo')
        importar_excel('Tabela de Países.xlsx', Pais, 'pais_nome', 'pais_codigo')

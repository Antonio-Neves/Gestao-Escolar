    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aluno_saida_escola', models.CharField(blank=True, choices=[('1', 'Acompanhado'), ('2', 'Sozinho'), ('3', 'Transporte escolar')], default='1', max_length=1, verbose_name='Saída da escola')),
                ('aluno_ensino_outro_lugar', models.CharField(blank=True, choices=[('1', 'Não'), ('2', 'Hospital'), ('3', 'Domicílio')], max_length=1, verbose_name='Ensino em outro lugar')),
                ...
                ('aluno_observacoes', models.TextField(blank=True, verbose_name='Observações')),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aluno_situacao', models.CharField(choices=[('A', 'Ativo'), ('I', 'Inativo'), ('T', 'Transferido'), ('C', 'Cancelado'), ('D', 'Desistente'), ('F', 'Falecido'), ('R', 'Remanejado')], max_length=1, verbose_name='Situação do aluno(a)')),
                ...
                ('aluno_certidao_nova', models.CharField(blank=True, max_length=40, null=True, unique=True, validators=[base.validators.validate_certidao_nascimento, base.validators.validate_digits], verbose_name='Certidão de nascimento - nova')),
                ...
                ('aluno_data_nascimento', models.DateField(max_length=10, validators=[base.validators.validate_data_nasc], verbose_name='Data de nascimento')),
                ...
                ('aluno_complemento_residencia', models.CharField(blank=True, max_length=20, verbose_name='Complemento')),
                ('aluno_bairro_residencia', models.CharField(blank=True, max_length=50, verbose_name='Bairro')),
                ('aluno_cep_residencia', models.CharField(default='68537-000', max_length=9, validators=[base.validators.validate_cep], verbose_name='CEP')),
                ...
                ('aluno_filiacao', models.CharField(max_length=1, verbose_name='Filiação')),
                ...
                ('aluno_deficiencia', models.CharField(max_length=1, verbose_name='Tem Deficiência Física')),
                ...
                ('aluno_nenhuma_necessidade', models.CharField(blank=True, max_length=1, verbose_name='Nenhuma necessidade especial')),
                ...
                ('aluno_alergia_tipo', models.CharField(blank=True, max_length=50, verbose_name='Tipo de alergia')),
                ('aluno_alergia_cuidados', models.CharField(blank=True, max_length=50, verbose_name='Alergia cuidados')),
                ('aluno_apto_edfisica', models.CharField(blank=True, max_length=1, verbose_name='alergia')),
                ('aluno_convenio', models.CharField(blank=True, max_length=1, verbose_name='convenio')),
                ('aluno_convenio_nome', models.CharField(blank=True, max_length=50, verbose_name='Nome do convenio')),
                ('aluno_convenio_contato', models.CharField(blank=True, max_length=50, verbose_name='Contato do convenio')),
                ('aluno_progrma_social', models.CharField(blank=True, max_length=1, verbose_name='Programa social')),
                ('aluno_programa_social_nome', models.CharField(blank=True, max_length=50, verbose_name='Nome do programa social')),
                ('aluno_emergencia_nome', models.CharField(blank=True, max_length=100, verbose_name='Emergencia nome')),
                ('aluno_emergencia_ddd', models.CharField(blank=True, default=94, max_length=2, validators=[base.validators.validate_ddd, base.validators.validate_digits], verbose_name='Emergencia DDD Telefone')),
                ('aluno_emergencia_telefone', models.CharField(blank=True, max_length=9, validators=[base.validators.validate_phone, base.validators.validate_digits], verbose_name='Emergencia telefone')),
                ('aluno_emergencia_parentesco', models.CharField(blank=True, max_length=50, verbose_name='Emergencia parentesco')),
                ('aluno_saida_escola', models.CharField(blank=True, max_length=1, verbose_name='Saída da escola')),
                ('aluno_ensino_outro_lugar', models.CharField(blank=True, max_length=1, verbose_name='Ensino em outro lugar')),
                ...
                ('aluno_aquaviario_outro', models.CharField(blank=True, max_length=1, verbose_name='Particular')),
                ...
                ('aluno_municipio_nascimento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='alunomunicipionascimento', to='base.municipio', verbose_name='Município')),
                ('aluno_municipio_residencia', models.ForeignKey(default='Canaã dos Carajás', on_delete=django.db.models.deletion.DO_NOTHING, related_name='alunomunicipioresidencia', to='base.municipio', verbose_name='Município')),

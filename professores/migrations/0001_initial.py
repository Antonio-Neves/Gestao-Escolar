    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professor_ddd1', models.CharField(blank=True, max_length=2, validators=[base.validators.validate_ddd, base.validators.validate_digits], verbose_name='professor - DDD Telefone')),
                ('professor_telefone1', models.CharField(blank=True, max_length=9, validators=[base.validators.validate_phone, base.validators.validate_digits], verbose_name='professor - Telefone')),
                ('professor_ddd2', models.CharField(blank=True, max_length=2, validators=[base.validators.validate_ddd, base.validators.validate_digits], verbose_name='professor - DDD Telefone')),
                ('professor_telefone2', models.CharField(blank=True, max_length=9, validators=[base.validators.validate_phone, base.validators.validate_digits], verbose_name='professor - Telefone')),
                ...
                ('professor_area_conhecimento1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='professorareaconhecimento1', to='base.areaconhecimento', verbose_name='Área do conhecimento')),
                ('professor_area_conhecimento2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='professorareaconhecimento2', to='base.areaconhecimento', verbose_name='Área do conhecimento')),
                ('professor_area_conhecimento3', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='professorareaconhecimento3', to='base.areaconhecimento', verbose_name='Área do conhecimento')),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professor_situacao', models.CharField(choices=[('0', 'Ativo'), ('1', 'Inativo'), ('2', 'Demitido'), ('3', 'Curriculo'), ('4', 'Atestado'), ('5', 'Temporário'), ('6', 'Substituto'), ('7', 'Estagiário')], max_length=1, verbose_name='Situação do professor(a)')),
